  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#F6F3EE' }}>
      <style>{`
        ...
        .hero-headline { font-family: 'Cormorant Garamond', Georgia, serif; font-weight: 300; line-height: 1.1; letter-spacing: -0.02em; }
        .wave-divider { width: 100%; overflow: hidden; line-height: 0; }
        .btn-primary { background-color: #487A7B; color: #F6F3EE; padding: 14px 36px; border-radius: 60px; font-family: 'DM Sans', sans-serif; font-weight: 400; font-size: 15px; letter-spacing: 0.03em; transition: all 0.3s ease; display: inline-block; text-decoration: none; border: 2px solid transparent; }
        .btn-primary:hover { background-color: #3a6566; transform: translateY(-1px); box-shadow: 0 8px 25px rgba(72,122,123,0.3); }
        .btn-secondary { background-color: transparent; color: #487A7B; padding: 14px 36px; border-radius: 60px; font-family: 'DM Sans', sans-serif; font-weight: 400; font-size: 15px; letter-spacing: 0.03em; transition: all 0.3s ease; display: inline-block; text-decoration: none; border: 1.5px solid #487A7B; }
        .btn-secondary:hover { background-color: rgba(72,122,123,0.05); transform: translateY(-1px); }
        .feature-card { background: #FFFFFF; border-radius: 24px; padding: 40px 36px; transition: all 0.3s ease; border: 1px solid rgba(212,165,165,0.15); }
        .feature-card:hover { transform: translateY(-4px); box-shadow: 0 20px 50px rgba(72,122,123,0.1); }
        .step-number { font-family: 'Cormorant Garamond', Georgia, serif; font-size: 64px; font-weight: 300; line-height: 1; color: rgba(72,122,123,0.12); margin-bottom: 8px; }
        .trust-badge { display: flex; align-items: flex-start; gap: 14px; padding: 24px; background: rgba(255,255,255,0.7); border-radius: 16px; border: 1px solid rgba(156,175,136,0.2); }
        .divider-rose { height: 1px; background: linear-gradient(to right, transparent, #D4A5A5, transparent); margin: 0 auto; max-width: 200px; }
      ...
      {/* Hero — centered */}
      <section style={{ padding: '100px 32px 110px', maxWidth: '780px', margin: '0 auto', textAlign: 'center' }}>
        <p className="sans" style={{ color: '#9CAF88', fontSize: '13px', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '28px', fontWeight: 400 }}>
          AI-powered postpartum support
        </p>
        <h1 className="hero-headline" style={{ fontSize: 'clamp(52px, 6vw, 80px)', color: '#487A7B', marginBottom: '12px' }}>
          Because mothers
        </h1>
        <h1 className="hero-headline" style={{ fontSize: 'clamp(52px, 6vw, 80px)', color: '#D4A5A5', marginBottom: '36px', fontStyle: 'italic' }}>
          need monitoring too.
        </h1>
      ...
      <section style={{ backgroundColor: '#FFFFFF', padding: '80px 32px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '80px', alignItems: 'center' }}>
          <div style={{ borderRadius: '28px', background: 'linear-gradient(160deg, #F6F3EE 0%, #EAE5DD 100%)', aspectRatio: '4/3', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
